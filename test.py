...
state_dict = torch.load('checkpoint/detr_demo-da2a99e9.pth', map_location='cpu')
...
def detect(im, model, transform):
    ...
    img = transform(im).unsqueeze(0)  # [C, H, W] -> [1, C, H, W]  模型需要输入批量数据，这里batch_size为1
...
im = Image.open('test_img/cat.png')
